...
export const countStudentAPI = async () => {
    try {
        const response = await axios.get('http://backend:5000/api/student/count');
...
export const countTeacherAPI = async () => {
  try {
      const response = await axios.get('http://backend:5000/api/teacher/count');
      return response.data.count;
  } catch (error) {
...
export const countReportAPI = async () => {
  try {
    const response = await axios.get('http://backend:5000/api/report/count');
    return response.data.count;
  } catch (error) {
...
export const countClassroomAPI = async () => {
  try {
    const response = await axios.get('http://backend:5000/api/classroom/count');
    return response.data.count;
  } catch (error) {
...
export const countPracticeAPI = async () => {
  try {
    const response = await axios.get('http://backend:5000/api/practices/count');
    return response.data.count;
  } catch (error) {
